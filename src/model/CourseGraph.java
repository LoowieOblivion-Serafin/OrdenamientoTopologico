...
public class CourseGraph {
    ...
    /**
     * Ajustamos addPrerequisite para mayor robustez
     * Verison anterior:
     *
    ...
    public void addPrerequisite(String courseCode, String prerequisiteCode) {
        // Si no existía ese prerequisito, lo añadimos vacío
        if (!courses.containsKey(prerequisiteCode)) {
            Course ghost = new Course(prerequisiteCode, "(nombre desconocido)");
            addCourse(ghost);
        }
